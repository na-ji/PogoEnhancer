...
namespace Gum
{
    ...
    InvocationListenerProxy::InvocationListenerProxy (AbstractInvocationListener * listener)
    ...
    void InvocationListenerProxy::on_enter (AbstractInvocationContext * context)
    {
        listener->on_enter (context);
    }

    void InvocationListenerProxy::on_leave (AbstractInvocationContext * context)
    {
