...
#ifndef DROID_PLUSPLUS_FORMPOSSIBLE_H
#define DROID_PLUSPLUS_FORMPOSSIBLE_H


#include "../gumpp_new/AbstractInvocationListener.h"

class FormPossible : public Gum::AbstractInvocationListener{
public:
...
#endif //DROID_PLUSPLUS_FORMPOSSIBLE_H
