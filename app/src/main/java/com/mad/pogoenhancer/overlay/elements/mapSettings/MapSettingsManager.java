...
public class MapSettingsManager extends OverlayFragmentManager {
    public MapSettingsManager(OverlayManager overlayManager, Context context) {
    ...
    protected WindowManager.LayoutParams getLayoutParams() {
        ...
        params.x = this._sharedPreferences.getInt(
                Constants.SHAREDPERFERENCES_KEYS.LAST_OVERLAY_X_MAP_SETTINGS,
                Constants.DEFAULT_VALUES.LAST_OVERLAY_X_MAP_SETTINGS
        );
        params.y = this._sharedPreferences.getInt(
                Constants.SHAREDPERFERENCES_KEYS.LAST_OVERLAY_Y_MAP_SETTINGS,
                Constants.DEFAULT_VALUES.LAST_OVERLAY_Y_MAP_SETTINGS
        );
        return params;
    }
    ...
    protected int getContentLayoutRes() {
        return R.layout.overlay_map_settings;
    }
    ...
    protected void storeLocation(int offsetX, int offsetY) {
        ...
        edit.putInt(
                Constants.SHAREDPERFERENCES_KEYS.LAST_OVERLAY_X_MAP_SETTINGS, offsetX
        );
        edit.putInt(
                Constants.SHAREDPERFERENCES_KEYS.LAST_OVERLAY_Y_MAP_SETTINGS, offsetY
        );
        edit.apply();
    }
}
