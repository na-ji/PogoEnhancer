...
public class AbstractInjectionSettingDialogPreference extends AbstractInjectionSetting implements
    ...
    public AbstractInjectionSettingDialogPreference(
    ...
    public AbstractInjectionSettingDialogPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AbstractInjectionSettingDialogPreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.dialogPreferenceStyle);
    }

    public AbstractInjectionSettingDialogPreference(Context context) {
        this(context, null);
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        final AbstractInjectionSettingDialogPreference.SavedState myState
                = new AbstractInjectionSettingDialogPreference.SavedState(superState);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state == null || !state.getClass().equals(AbstractInjectionSettingDialogPreference.SavedState.class)) {
            // Didn't save state for us in onSaveInstanceState
            super.onRestoreInstanceState(state);
            return;
        }

        AbstractInjectionSettingDialogPreference.SavedState myState = (AbstractInjectionSettingDialogPreference.SavedState) state;
    ...
    private static class SavedState extends AbstractInjectionSettingDialogPreference.BaseSavedState {
        ...
        public static final Parcelable.Creator<AbstractInjectionSettingDialogPreference.SavedState> CREATOR =
                new Parcelable.Creator<AbstractInjectionSettingDialogPreference.SavedState>() {
                    public AbstractInjectionSettingDialogPreference.SavedState createFromParcel(Parcel in) {
                        return new AbstractInjectionSettingDialogPreference.SavedState(in);
                    }

                    public AbstractInjectionSettingDialogPreference.SavedState[] newArray(int size) {
                        return new AbstractInjectionSettingDialogPreference.SavedState[size];
                    }
                };
    }
